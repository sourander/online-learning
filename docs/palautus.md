...
* Esittelet Azureun luodun kokonaisuuden, joka on:
    ...
    * 2C tasolla (maksimiarvosana 5, lisäpisteitä `Koodi`-kriteeriin)
* Palvelu nostetaan pystyyn videolla (`terraform apply`)
* Palvelu näkyy ajossa. Selaimessasi näkyy Azure Portal ja siellä luodut palvelut.
