...
1. Kopioi harjoituksen (TODO! TARKISTA TÄMÄ) koodit toiseen kansioon.
2. Muokkaa koodia niin, että siinä kopioidaan kaikki tarvittavat tiedostot Azure Blob storageen.
